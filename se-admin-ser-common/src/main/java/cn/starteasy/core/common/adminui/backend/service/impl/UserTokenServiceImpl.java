...
public class UserTokenServiceImpl extends AbstractPageService<Integer, IUserTokenDAO, UserToken> implements IUserTokenService {
    @Autowired
    private IUserTokenDAO userTokenDAO;

    @Override
    public IUserTokenDAO getDao() {
        return userTokenDAO;
    }
