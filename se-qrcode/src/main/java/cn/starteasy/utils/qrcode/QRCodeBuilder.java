package cn.starteasy.utils.qrcode;
...
import cn.starteasy.core.utils.Base64Code;
...
public class QRCodeBuilder {
    ...
    public static void main(String[] args) throws WriterException {
        try {
            ...
            qrCodeBuilder.getLogoQRCode("http://172.16.222.93:8080/sos.html", "电梯维保系统");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
// String filePath = request.getSession().getServletContext().getRealPath("/") + "resources/images/logoImages/llhlogo.png";
        ...
        String filePath = path + "../../resources/main/image/a1.jpg";  //TODO
        String content = qrUrl;
        try {
            QRCodeBuilder zp = new QRCodeBuilder();
...
// outg.drawString(productName, 0, image.getHeight() + (outImage.getHeight() - image.getHeight())/2 + 5 ); //画文字
            ...
            String path = this.getClass().getResource("/").getPath();
            ImageIO.write(image, "png", new File(path + "/TDC-" + new Date().getTime() + "test.png")); //TODO

            String imageBase64QRCode = Base64Code.encodeString(baos.toByteArray());//Base64.byteArrayToBase64(baos.toByteArray());
            baos.close();
